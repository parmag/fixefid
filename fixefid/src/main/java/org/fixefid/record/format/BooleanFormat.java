package org.fixefid.record.format;
...
public interface BooleanFormat {
	/**
	 * Format the boolean <code>value</code> param to produce a formatted string
	 * 
	...
	/**
	 * Parses the <code>value</code> string param to produce a boolean.
	 * 
